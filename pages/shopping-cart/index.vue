      ...
      <div class="md:col-span-8 p-2 bg-white">
        ...
        >
          ...
          <nuxt-link to="/">
            <button
              type="button"
              class="mt-2 text-xs text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg px-5 py-2.5 text-center me-2 mb-2"
            >
              Continue Shopping
            </button>
          </nuxt-link>
